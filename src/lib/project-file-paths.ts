...
const KNOWN_PROJECT_FILE_PATHS = {
  ...
  "data/football-form/team-shots-opponent-shadow.csv": path.join(process.cwd(), "data/football-form/team-shots-opponent-shadow.csv"),
  "data/football-form/team-shots-opponent-candidates.csv": path.join(process.cwd(), "data/football-form/team-shots-opponent-candidates.csv"),
  "data/football-form/team-shots-opponent-status.json": path.join(process.cwd(), "data/football-form/team-shots-opponent-status.json"),
