...
const KNOWN_PROJECT_FILE_PATHS = {
  ...
  "data/backtest/strict-signals-claycal-archive.csv": path.join(process.cwd(), "data/backtest/strict-signals-claycal-archive.csv"),
  "data/backtest/strict-signals-claycal-live.csv": path.join(process.cwd(), "data/backtest/strict-signals-claycal-live.csv"),
