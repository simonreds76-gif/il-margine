  ...
  const steps = [
    {
      ...
      body: "Enter your total bankroll (optional) and unit size as a % of bankroll. We recommend 1 to 2% per unit.",
      icon: (
    ...
    {
      title: "Choose your total stake",
      body: "Enter how many units you plan to stake over the period (e.g. 100 units over a month).",
      icon: (
        <svg className="w-8 h-8 text-emerald-400/90" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden>
    ...
    {
      title: "Get an illustrative estimate",
      body: "We apply our historical ROI to your total stake. Result is illustrative only, not a prediction.",
      icon: (
        <svg className="w-8 h-8 text-emerald-400/90" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden>
