      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        ...
        <div id="fixture-lineups" className="mb-8">
          {showInlineFixtureLineups ? (
            ...
            <MonitorCard
              title="Fixture lineups"
              subtitle="The full lineup reference has moved off the main board so the operator view stays lighter."
            >
              <div className="flex flex-col gap-4 rounded-xl border border-slate-800/80 bg-slate-950/35 p-4 sm:flex-row sm:items-center sm:justify-between">
                <div className="text-sm leading-6 text-slate-300">
                  Open the dedicated lineup page when you want the full starter-by-starter reference without loading it inline on the main monitor.
                </div>
                <Link
                  href="/model-monitor/goalscorer/lineups"
                  className="inline-flex items-center justify-center rounded-full border border-emerald-500/30 bg-emerald-500/10 px-4 py-2 text-sm font-medium text-emerald-200 transition-colors hover:border-emerald-400/40 hover:text-emerald-100"
                >
                  Open Fixture Lineups
                </Link>
              </div>
            </MonitorCard>
          )}
