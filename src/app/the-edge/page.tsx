      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16 space-y-10">
        ...
        <section className="bg-[#1a1d24] rounded-xl border border-slate-800 p-6 md:p-8">
          ...
          <div className="space-y-4 text-slate-300 leading-relaxed text-base">
            ...
            <p>For goalscorer-style markets, the same logic applies to set-piece roles. Penalty duty changes pricing immediately, which is why we keep a live <Link href="/penalty-takers" className="text-emerald-400 hover:text-emerald-300 underline">penalty takers reference</Link> instead of relying on stale season-open assumptions.</p>
        ...
        <section className="bg-[#1a1d24] rounded-xl border border-slate-800 p-6 md:p-8">
          ...
          <div className="space-y-4 text-slate-300 leading-relaxed text-base">
            ...
            <p><strong className="text-slate-100">Singles only:</strong> Accumulators compound bookmaker margin. A five-fold with 5% margin per leg = 22.6% total margin against you. We don&apos;t give away 20%+ edge before the match even starts. Every pick stands on its own merit.</p>
          </div>
        </section>
