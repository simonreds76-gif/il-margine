        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="relative">
                ...
                {tipsMenuOpen && (
                  <div className="absolute top-full left-0 mt-2 w-48 bg-slate-900 border border-slate-800 rounded-lg shadow-xl z-50">
                    ...
                    <Link href="/anytime-goalscorer" className="block px-4 py-2 text-sm text-emerald-400 hover:bg-slate-800">Anytime Goalscorer</Link>
          ...
          {mobileMenuOpen && (
            <div className="md:hidden border-t border-slate-800/50 py-4 space-y-3">
              ...
              <Link href="/anytime-goalscorer" className="block px-4 py-2 text-sm text-emerald-400 font-medium hover:bg-emerald-500/10 rounded transition-colors">Anytime Goalscorer</Link>
