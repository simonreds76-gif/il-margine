...
export default function BookmakersPage() {
  ...
  return (
    <div className="min-h-screen bg-[#0f1117] text-slate-100">
      <section className="relative py-12 md:py-20 border-b border-slate-800/50 overflow-hidden">
      ...
      <section className="py-16 border-b border-slate-800/50 bg-gradient-to-b from-slate-900/30 to-transparent">
      ...
      <section className="py-16 border-t border-slate-800/50 bg-gradient-to-b from-slate-900/30 to-slate-900/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center gap-2 mb-6">
