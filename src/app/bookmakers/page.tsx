...
const BOOKMAKERS = [
  ...
  },
  {
    ...
    strengths: [
      "Established UK sportsbook with a broad football-first market set",
      "Cash Out is available across a wide range of pre-match and in-play bets",
      "Live streaming and a strong mobile app/site push make it usable on the go",
      "Good mainstream football coverage and plenty of promotional visibility",
      "Tennis is covered well enough on ATP/WTA headline events",
      "Useful extra line-shopping account if you already have the core books",
    ],
    weaknesses: [
      "The £10 → £40 welcome offer is less flexible than it first looks",
      ...
      "Odds are rarely best-in-class on the markets we care about most",
      "Like most recreational books, it is not a long-term home for winning accounts",
    ],
    usageTips: "Betway is more useful as a broad secondary sportsbook than as a specialist one. The official site leans hard into football, mobile, Cash Out and live streaming, and that matches how we’d treat it: a decent account to have in rotation for mainstream football and occasional line shopping, but not a book we’d build our tennis operation around. For props: worth checking on big leagues and televised matches, especially if you already price-shop across several books. For tennis: fine on ATP/WTA headline matches, but we would still prioritise BetVictor and William Hill before it. The welcome offer is attractive at first glance, but the free-bet tokens come with extra bet-builder/acca restrictions, so don’t overvalue it.",
    bestFor: "Football promos, mobile betting, secondary line shopping",
...
const COMPARISON_ROWS = [
  ...
  { name: "Betway", props: "7/10", tennis: "6/10", offer: "£40 free bets", bestFor: "Football promos, mobile betting, secondary line shopping" },
];
