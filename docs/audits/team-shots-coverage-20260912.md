...
Publication timestamp follow-up: newly matched signals now keep their first actual publication separately from price_captured_at_utc. The two newly generated corners rows were corrected to the recorded 18:36:31 UTC generation; no older published rows were redated. Eleven vNext tests now pass, including a regression for old prices producing new signals.
