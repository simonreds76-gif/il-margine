...
def build_pick_row(
    ...
    *,
    ...
    return {
        ...
        "model_input_version": pick.get("model_input_version", ""),
        "price_captured_at_utc": pick.get("price_captured_at_utc", ""),
        "market_strength_captured_at_utc": pick.get("market_strength_captured_at_utc", ""),
