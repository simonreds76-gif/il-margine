...
if ($grassBo3Enabled) {
    Log "=== Step 8g/10: Grass bo3 internal shadow (ATP grass warm-up ML 10-30%, favourite agreement) ==="
    $prevInternalResearchLanes = $env:INTERNAL_RESEARCH_LANES
    $env:INTERNAL_RESEARCH_LANES = "1"
    try {
    ...
    Log "=== Step 8g/10: Grass bo3 shadow skipped (STRICT_GRASS_BO3_ENABLED=0) ==="
}
