#!/usr/bin/env python3
"""Apply the active run-status cadence migration."""
...
MIGRATION = ROOT / "db" / "migrations" / "20260717_0001_run_status_active_cadence.sql"
...
def main() -> int:
    ...
    print("Applied active run-status cadence migration.")
    return 0
