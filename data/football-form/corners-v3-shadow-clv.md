...
Generated: 2026-09-19T12:33:27Z
...
- Picks: 75
- Active published picks: 75
- Settled: 57
- Open/pending: 18
- Settled PnL: -3.19u
- Picks with close: 75
- True-close coverage (<=120m): 22/61 (36.1%)
- Average true-close CLV: +1.40% (n=22)
- Hard-guard blocked: 0
- Average published-to-close CLV: +1.44%
...
| Under | 59 | 42 | 17 | 20-22-0 | +0.00u | +0.00% | +2.52% (n=42) |

## Active League Breakdown

| Segment | Active | Settled | Pending | W-L-P | PnL | ROI | Avg CLV |
|---|---:|---:|---:|---:|---:|---:|---:|
| bundesliga | 9 | 5 | 4 | 0-5-0 | -5.00u | -100.00% | +2.48% (n=5) |
| epl | 11 | 7 | 4 | 5-2-0 | +2.93u | +41.80% | +2.27% (n=7) |
| la-liga | 18 | 14 | 4 | 8-6-0 | +2.96u | +21.14% | +4.03% (n=14) |
| ligue-1 | 23 | 18 | 5 | 7-11-0 | -2.65u | -14.74% | +2.02% (n=18) |
...
| Under / bundesliga | 9 | 5 | 4 | 0-5-0 | -5.00u | -100.00% | +2.48% (n=5) |
| Under / epl | 11 | 7 | 4 | 5-2-0 | +2.93u | +41.80% | +2.27% (n=7) |
| Under / la-liga | 12 | 8 | 4 | 7-1-0 | +6.96u | +87.00% | +4.98% (n=8) |
| Under / ligue-1 | 22 | 17 | 5 | 7-10-0 | -1.65u | -9.73% | +2.14% (n=17) |
