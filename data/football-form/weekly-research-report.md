...
- Generated: 2026-08-28T17:19:00Z
...
- Team Shots v4 latest scan: EXPECTED_WARMUP_BLOCK; 48 rows / 12 fixtures scored; 3 fixtures passed edge but were warm-up blocked; blockers {'edge_below_3pct': 45, 'matchdays_1_to_3': 48}.
...
- Corners v3 latest scan: EXPECTED_WARMUP_BLOCK; 136 rows / 25 fixtures scored; 12 fixtures passed edge but were warm-up blocked; blockers {'edge_below_3pct': 106, 'matchdays_1_to_3': 136}.
...
- Live CLV sample: 83 published, 83 settled
...
- Real-price CLV coverage: 0/60 (0.0%) | true closes 0.
- Settled ledger: 57/60 settled, 12W/42L, -15.75u, ROI -27.6%.
- Extreme-gap quarantine: 0/0 settled, +0.00u at 1u evaluation stakes, ROI -.
- Extreme-gap by league: no rows registered yet.
- Evidence freshness: FRESH (2026-08-27T19:47:54Z).
...
- Evidence freshness: FRESH (2026-08-28T17:18:50Z).
...
- Prospective evidence: 68/600 settled across 53/150 events; P/L -16.40u; ROI -24.1%; CLV +0.83% n=6.
...
Generated UTC: 2026-08-28T09:21:19Z
Status: COLLECTING_EVIDENCE (never auto-promoted)

Sample: 19/20 settled; 1 pending; 0 void
Record: 10W/9L/0P
P/L: +4.46u | ROI: +23.5%
CLV: +7.15% mean; 42.9% positive; n=7
Calibration: Brier 0.22686; predicted 52.1%; actual 52.6%; gap 0.6pp; n=19
Feed: SHADOW_EVIDENCE_READY; matched 177/188; two-way 84; over-only 104; public bettable 0

By market:
- aces: 14/14 settled, -0.30u, ROI -2.1%
- double_faults: 5/6 settled, +4.76u, ROI +95.2%

Blockers: settled sample 19/300; Slam coverage 1/2; CLV sample 7/300; calibration sample 19/100
